        ...
        <form action="{{ route('admin.assets.store') }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Contoh: Laptop Dell Latitude 5420" required>
                </div>
                <div class="col-md-3">
                    {{-- KATEGORI: Sumber dari AssetController::CATEGORIES --}}
                ...
                <div class="col-md-3">
                    {{-- KONDISI: Sumber dari AssetController::CONDITIONS --}}
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="brand" class="form-control" value="{{ old('brand') }}" placeholder="Dell, HP, Canon, dll.">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Model / Seri</label>
                    <input type="text" name="model" class="form-control" value="{{ old('model') }}" placeholder="Latitude 5420, LaserJet M203, dll.">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Serial Number</label>
                    <input type="text" name="serial_number" class="form-control" value="{{ old('serial_number') }}" placeholder="SN dari sticker perangkat">
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="location" class="form-control" value="{{ old('location') }}" placeholder="Ruang HRD, Lantai 2, dll.">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Pemegang / Ditugaskan kepada</label>
                    <input type="text" name="assigned_to" class="form-control" value="{{ old('assigned_to') }}" placeholder="Nama orang atau divisi">
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="purchase_price" class="form-control" value="{{ old('purchase_price') }}" placeholder="0" min="0">
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <textarea name="specs" class="form-control" rows="4" placeholder="Contoh: RAM 16GB, SSD 512GB, Prosesor Intel i5-Gen12">{{ old('specs') }}</textarea>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Catatan Tambahan</label>
                    <textarea name="notes" class="form-control" rows="4" placeholder="Informasi lain yang perlu dicatat...">{{ old('notes') }}</textarea>
                </div>
            </div>

            <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                <a href="{{ route('admin.assets.index') }}" class="btn btn-light">Batal</a>
